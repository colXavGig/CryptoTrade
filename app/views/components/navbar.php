    ...
    <div id="nav-container">
        ...
        <ul class="nav-row">
            ...
            if (isset($_SESSION['jwt'])) :
                ...
                echo '<li><strong>Welcome ' . htmlspecialchars($user['email']) . '</strong></li>';
                echo '<li><a href="#" id="logout-link">Logout</a></li>';
            else :
                ?>
...
<script>
    ...
    document.addEventListener('click', (e) => {
        const isClickInsideNav = navContainer.contains(e.target) || hamburgerBtn.contains(e.target);
        if (!isClickInsideNav && navContainer.classList.contains('active')) {
            navContainer.classList.remove('active');
        }
    });
</script>
